# [Data Science & Machine Learning Guide](https://github.com/krmiddlebrook/intro_to_deep_learning/tree/master/machine_learning)
Navigate to the [machine_learning](https://github.com/krmiddlebrook/intro_to_deep_learning/tree/master/machine_learning) directory to see lessons and challenges.

### Summary
The goal of this series is to enable students to apply machine learning and data science techniques to solve real-world problems. I am especially focused on enabling you to use deep learning models to solve tasks you care about. To make the concepts more approachable, I take a *top-down learning* method to teaching: each lesson includes some new material that is presented through a practical application on real-world data.

Your journey into deep learning begins with learning linear regression--a simple yet fundamental algorithm in machine learning. Next, you will learn about logistic regression--an extension of linear regression--to solve classification problems. Throughout these lessons you'll be introduced to the fundamental elements of deep learning like neural networks, supervised learning, data preprocessing, loss functions, and optimization algorithms. Afterwards, you'll learn how to build your first deep neural networks from scratch. By the final lesson, you will be able to build a feed forward neural network (from scratch) that can recognize 10 types of handwritten digits!
...
Although our guided lessons end after the section on neural networks, I encourage interested students to continue exploring deep learning. To help you learn, we've included some excellent advanced deep learning resources in the [Advanced Deep Learning Resources](#-Advanced-Deep-Learning-Resources) section.           
...
## [Lesson 0: Introduction to Machine Learning](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/lesson%200%20-%20machine%20learning/Intro_to_Machine_Learning.ipynb)
...
## [Lesson 1: Linear Regression](https://github.com/krmiddlebrook/intro_to_deep_learning/tree/master/machine_learning/lesson%201%20-%20linear%20regression)
...
- [Mini Lesson: Cleaning and Preparing Data](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/mini_lessons/Cleaning_Data.ipynb)
...
- [Single-variable Linear Regression using a Neural Network - Deep Dive](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/lesson%201%20-%20linear%20regression/examples/linear-regression-deep-dive.ipynb)
  - *Challenges:*
...
## [Lesson 2: Classification with Logistic and Softmax Regression](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/lesson%202%20-%20logistic%20regression/)
...
- [Mini Lesson: Finding and preparing image data](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/mini_lessons/image_data.ipynb)
...
## [Lesson 3: Neural Networks and Deep Learning](https://github.com/krmiddlebrook/intro_to_deep_learning/tree/master/machine_learning/lesson%203%20-%20Neural%20Networks)
...
- [Introduction to Neural Networks](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/lesson%203%20-%20Neural%20Networks/intro-to-neural-networks.ipynb)
...
- [Mini lesson: Using external image datasets in Colab](https://github.com/krmiddlebrook/intro_to_deep_learning/blob/master/machine_learning/mini_lessons/external-datasets-in-colab.ipynb)
  - *Challenges:*
